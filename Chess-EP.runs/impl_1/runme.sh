...
HD_PWD='C:/Xilinx/EEC_EP/projeto/Chess-EP/Chess-EP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kb_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kb_test.tcl -notrace
