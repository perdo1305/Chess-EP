...
HD_PWD='C:/Xilinx/EEC_EP/projeto/Chess-EP/Chess-EP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kb_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kb_test.tcl
